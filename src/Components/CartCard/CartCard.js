...
function CartCard(props) {
  const [Voucher, SetVoucher] = useState({
    ...
    quantity: props.VoucherInfo.quantity,
  });
  ...
  const handleChange = (e) => {
    ...
    props.handleAddToCart(Voucher);
  };

  return (
    <div className="cart-product mb-3">
      <div className="row">
        <div className="col-9">
          <div className="row">
            ...
            <div className="col-12 col-lg-8 flex-grow-1 cart-product-detail">
              <h2>{Voucher.title}</h2>
              <h6>INR: {Math.floor(Voucher.price)}</h6>
              <h6>Quantity: {Math.floor(Voucher.quantity)}</h6>
              <div className="voucher-option mt-3">
        ...
        <div className="col-3 cart-product-action">
          <button
            className="cart-product-remove"
            onClick={() => props.handleRemoveToCart(props.VoucherInfo.id)}
          >
            <svg
              fill="#000000"
